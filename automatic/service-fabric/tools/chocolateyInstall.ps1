...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://download.microsoft.com/download/b/8/a/b8a2fb98-0ec1-41e5-be98-9d8b5abf7856/MicrosoftServiceFabric.11.4.205.1.exe'
  checksum       = 'e626e58829b21dd24aaa0c6ee9cd43001bca20a11a2b82e8ad1f7af43a40aca1'
  checksumType   = 'sha256'
