...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://download.microsoft.com/download/b/8/a/b8a2fb98-0ec1-41e5-be98-9d8b5abf7856/MicrosoftServiceFabric.8.1.321.9590.exe'
  checksum       = 'ec208d3f9ccee7637ebec5a4babd5fdadbe0ec0902d4ccce5e2f9e6bb05e1ed1'
  checksumType   = 'sha256'
