...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://download.microsoft.com/download/b/8/a/b8a2fb98-0ec1-41e5-be98-9d8b5abf7856/MicrosoftServiceFabric.8.1.316.9590.exe'
  checksum       = 'b893e257042714b6ddf6a904352761e6ed200606d146f3faef4649070f28b4be'
  checksumType   = 'sha256'
