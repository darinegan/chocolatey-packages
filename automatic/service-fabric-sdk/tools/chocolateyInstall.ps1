...
$packageArgs = @{
  ...
  fileType       = 'msi'
  url            = 'https://download.microsoft.com/download/b/8/a/b8a2fb98-0ec1-41e5-be98-9d8b5abf7856/MicrosoftServiceFabricSDK.5.1.316.msi'
  checksum       = '18b28448e7e4d56ddb8d815b089a8e46c993c18fe94fa1d328cf464efdb799ee'
  checksumType   = 'sha256'
