...
$packageArgs = @{
  ...
  fileType       = 'msi'
  url            = 'https://download.microsoft.com/download/b/8/a/b8a2fb98-0ec1-41e5-be98-9d8b5abf7856/MicrosoftServiceFabricSDK.5.2.1235.msi'
  checksum       = 'c0e7554b2f921b1f363b3e17cb996e6ba5b611cd47787a6fbf9be1fdc3f3e805'
  checksumType   = 'sha256'
