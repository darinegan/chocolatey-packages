...
$packageArgs = @{
  ...
  fileType       = 'msi'
  url            = 'https://download.microsoft.com/download/b/8/a/b8a2fb98-0ec1-41e5-be98-9d8b5abf7856/MicrosoftServiceFabricSDK.8.4.268.msi'
  checksum       = 'd92ecdbd0b5777cf0410d5fe873cd5325a87976872a93d6e79a1695170602401'
  checksumType   = 'sha256'
