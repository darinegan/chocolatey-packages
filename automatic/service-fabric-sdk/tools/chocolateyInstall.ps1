...
$packageArgs = @{
  ...
  fileType       = 'msi'
  url            = 'https://download.microsoft.com/download/b/8/a/b8a2fb98-0ec1-41e5-be98-9d8b5abf7856/MicrosoftServiceFabricSDK.3.4.676.msi'
  checksum       = '71262834ac155a4a59b0fbba0b46cb40e053a382dab714b21249dcc65c63c203'
  checksumType   = 'sha256'
