...
$packageArgs = @{
  ...
  fileType       = 'msi'
  url            = 'https://download.microsoft.com/download/b/8/a/b8a2fb98-0ec1-41e5-be98-9d8b5abf7856/MicrosoftServiceFabricSDK.8.1.208.msi'
  checksum       = '84eb5e7904096dcacb666753362d8e4cc287cc54774dbe6f7c3d246676bc5f1a'
  checksumType   = 'sha256'
